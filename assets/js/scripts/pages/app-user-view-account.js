...
$(function () {
  ...
  $.ajax({
    type:"GET", 
    url: "https://backjgdev.joangoma.repl.co/apiv1" + userID, 
...
function setFirstName(username){
  $('#first-name').html(username)
  document.getElementById("modalEditUserFirstName").value = username;
}
function setRole(role){
  document.querySelectorAll('[id=user-role]').forEach(function(el) {
      el.innerHTML = role;
    });
}
function setEmail(email){
  document.querySelectorAll('[id=user-email]').forEach(function(el) {
      el.innerHTML = email;
  });
  document.getElementById("modalEditUserEmail").value = email;
}

function setUserName(username){
  document.querySelectorAll('[id=user-name]').forEach(function(el) {
...
function setUserCountry(country){
  document.querySelectorAll('[id=user-country]').forEach(function(el) {
